...
const updateReminder = async (req, res) =>
  res.json({ success: true, message: "Reminder updated", data: await service.updateReminder(req.user.id, req.params.id, pick(req.body, FIELDS), req.isPremium) });
...
// Refresh my automatic reminders right now
